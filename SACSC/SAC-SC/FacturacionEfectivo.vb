Public Class FacturacionEfectivo
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Next
        If Integer.Parse(Me.TextBox1.Text) >= total Then
            Me.Hide()
            FacturacionFactura.TextBox1.Text = Facturacion.TextBox3.Text
            FacturacionFactura.TextBox2.Text = "Verificar al iniciar sesión"
            FacturacionFactura.TextBox3.Text = "Efectivo"
            FacturacionFactura.TextBox4.Text = "¢ " & total
            FacturacionFactura.TextBox5.Text = "¢ " & Me.TextBox1.Text
            FacturacionFactura.TextBox6.Text = "¢ " & Me.TextBox1.Text - total
